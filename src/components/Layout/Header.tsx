...
export function Header({
    ...
    return (
        <motion.header
            ...
            className="border-b border-gray-800 sticky top-0 bg-gray-950/80 backdrop-blur-md z-50"
        >
            <div className="px-4 py-3">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-bold text-white">Crypto Intelligence</h1>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {/* WebSocket Status */}
                        <div
                            className="hidden sm:flex items-center gap-1.5 px-2 py-1 bg-gray-800/50 rounded text-xs"
