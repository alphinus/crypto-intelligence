...
export const TOUR_STEPS: TourStep[] = [
  ...
  // === PHASE 4: TABS ERKUNDEN ===
  {
    ...
    title: 'Die Tabs',
    content: 'Trading = Chart & Signale. Sentiment = Marktstimmung. ETF = Institutionelle Flows. Historie = Signal-Performance.',
    position: 'bottom',
    phase: 'tabs',
  },
  {
  ...
  {
    id: 'etf-tab',
    target: '[data-tour="etf-tab"]',
    title: 'ETF Flows Tab',
    content: 'Bitcoin Spot ETF Zu- und Abfluesse. Zeigt institutionelles Interesse.',
    beginnerContent: 'Wenn grosse Investoren (Institutionen) kaufen, steigt meist der Preis. Inflows = gut, Outflows = Vorsicht!',
    position: 'bottom',
    phase: 'tabs',
  },
  {
    ...
    title: 'Signal Historie Tab',
    content: 'Alle vergangenen Signale mit Win-Rate und Performance-Statistiken.',
    beginnerContent: 'Hier siehst du wie gut die Signale in der Vergangenheit waren. Win-Rate zeigt den Prozentsatz erfolgreicher Trades.',
    position: 'bottom',
    phase: 'tabs',
  },
  {
